...
const ChineseFlipPrviacyPage = () => {
  return (
    <Layout>
      <Content>
        <PageTitle>Chinese Flip Privacy Policy</PageTitle>

        <>
          <strong>Privacy Policy</strong>
          <p>
            Tim Rybicki built the Chinese Flip app as an Open Source app. This SERVICE is provided
            by Tim Rybicki at no cost and is intended for use as is.
          </p>
          <p>
          ...
          <p>
            ...
            Conditions, which are accessible at Chinese Flip unless otherwise defined in this
            Privacy Policy.
          </p>
          <p>
